  ...
  <div>
    <div class="page-content bg-white">
      <div
        ...
        style="background-image:url(images/banner/bnr3.jpg);"
      >
        <div class="container">
      ...
      <div class="content-block">
        <!-- About Services info -->
        <div
          class="section-full content-inner bg-white wow fadeIn"
                ...
                <div class="about-img">
                  ...
                  <div class="video-bx">
                    <a
                      ...
                      class="popup-youtube bg-primary"
