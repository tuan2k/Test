				...
				<div id="rev_slider_1164_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
					<ul>	
						<li data-index="rs-3204" data-transition="slideoververtical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="images/main-slider/slide8.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="2000" data-fsslotamount="7" data-saveperformance="off"  data-title="" data-param1="What our team has found in the wild" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
							<img src="/static/assets/images/main-slider/slide8.jpg"  alt=""  data-lazyload="images/main-slider/slide8.jpg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina>
							...
							<div class="tp-caption" 
								...
								style="z-index: 7; white-space: normal; color:#fff; font-family: 'Poppins', serif; border-width:0px; font-weight:600; font-family:'Merriweather', serif;">
								   Best Education For<br/>  EduZone University 
							</div>
							<div class="tp-caption tp-resizeme rs-parallaxlevel-1" 
								...
								<div class="rs-looped rs-wave"  data-speed="5" data-angle="0" data-radius="3px" data-origin="50% 50%">
									<img src="/static/assets/images/main-slider/slide7.png" alt="" data-ww="['965px','965px','500px','300px']" data-hh="['894px','894px','463px','278px']" width="407" height="200" data-no-retina> 
								</div>
							</div>
							<div class="tp-caption  " 
							...
							<a class="tp-caption rev-btn bg-primary btnhover13 tp-resizeme" 
								...
								style="z-index: 13; white-space: normal; font-size: 17px; line-height: 50px; font-weight: 500; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:Poppins;border-color:rgba(255, 255, 255, 1.00);border-style:solid;border-width:0;border-radius:4px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">Read More
							</a>
							<a class="tp-caption rev-btn tp-resizeme btnhover13" 
								href="about-1.html" target="_blank"			 
								...
								style="z-index: 13; white-space: normal; font-size: 17px; line-height: 50px; font-weight: 500; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:Poppins;background-color:rgba(255, 255, 255, 0);border-color:rgba(255, 255, 255, 1.00);border-style:solid;border-width:1px 1px 1px 1px;border-radius:4px;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;text-decoration: none;">About Us
							</a>
						</li>
					</ul>
				...
				<div class="container">
					<div class="row service-area-one">
						<div class="col-lg-4 m-b30 hidden-sm">
                            <div class="rdx-thu"><img src="/static/assets/images/student1.png" alt=""></div>
                        </div>
                        <div class="col-lg-8">
					...
					<div class="row">
							...
							<div class="dlab-box m-b30 dlab-team1">
								<div class="dlab-media">
									<a href="teachers-profile.html">
										<img width="358" height="460" alt="" src="images/our-team/preview.jpg" class="lazy" data-src="images/our-team/pic17.jpg">
									</a>
								</div>
								<div class="dlab-info">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
							<div class="dlab-box m-b30 dlab-team1">
								<div class="dlab-media">
									<a href="teachers-profile.html">
										<img width="358" height="460" alt="" src="images/our-team/preview.jpg" class="lazy" data-src="images/our-team/pic16.jpg">
									</a>
								</div>
								<div class="dlab-info">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.6s">
							<div class="dlab-box m-b30 dlab-team1">
								<div class="dlab-media">
									<a href="teachers-profile.html">
										<img width="358" height="460" alt="" src="images/our-team/preview.jpg" class="lazy" data-src="images/our-team/pic15.jpg">
									</a>
								</div>
								<div class="dlab-info">
						...
						<div class="col-lg-3 col-md-6 col-sm-6 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.8s">
							<div class="dlab-box m-b30 dlab-team1">
								<div class="dlab-media">
									<a href="teachers-profile.html">
										<img width="358" height="460" alt="" src="images/our-team/preview.jpg" class="lazy" data-src="images/our-team/pic18.jpg">
									</a>
								</div>
								<div class="dlab-info">
									<h4 class="dlab-title"><a href="teachers-profile.html">Konne Backfield</a></h4>
						...
						<div class="testimonial-two-dots owl-carousel owl-none owl-theme owl-dots-primary-full owl-loaded owl-drag">
							<div class="item">
								<div class="testimonial-15 quote-right">
									...
									<div class="testimonial-detail clearfix">
										<div class="testimonial-pic radius"><img src="/static/assets/images/testimonials/pic3.jpg" width="100" height="100" alt=""></div>
							...
							<div class="item">
								<div class="testimonial-15 quote-right">
									...
									<div class="testimonial-detail clearfix">
										<div class="testimonial-pic radius"><img src="/static/assets/images/testimonials/pic2.jpg" width="100" height="100" alt=""></div>
										<strong class="testimonial-name">David Matin</strong> <span class="testimonial-position">Student</span> 
									</div>
								</div>
							</div>
							<div class="item">
								<div class="testimonial-15 quote-right">
									...
									<div class="testimonial-detail clearfix">
										<div class="testimonial-pic radius"><img src="/static/assets/images/testimonials/pic1.jpg" width="100" height="100" alt=""></div>
										<strong class="testimonial-name">David Matin</strong> <span class="testimonial-position">Student</span> 
									</div>
								</div>
							</div>
						...
						<div class="client-logo-carousel mfp-gallery gallery owl-btn-center-lr owl-carousel owl-btn-3">
							<div class="item">
								<div class="ow-client-logo">
									<div class="client-logo"><a href="javascript:void(0);"><img src="/static/assets/images/client-logo/logo1.jpg" alt=""></a></div>
								</div>
							</div>
							<div class="item">
								<div class="ow-client-logo">
									<div class="client-logo"> <a href="javascript:void(0);"><img src="/static/assets/images/client-logo/logo2.jpg" alt=""></a> </div>
								</div>
							</div>
							<div class="item">
								<div class="ow-client-logo">
							...
							<div class="item">
								<div class="ow-client-logo">
									<div class="client-logo"> <a href="javascript:void(0);"><img src="/static/assets/images/client-logo/logo3.jpg" alt=""></a> </div>
								</div>
							</div>
							<div class="item">
								<div class="ow-client-logo">
									<div class="client-logo"> <a href="javascript:void(0);"><img src="/static/assets/images/client-logo/logo4.jpg" alt=""></a> </div>
								</div>
							</div>
							<div class="item">
								<div class="ow-client-logo">
