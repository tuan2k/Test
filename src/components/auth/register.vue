            ...
            <div class="col-md-6 col-lg-4">
              <div class="login-wrap p-0">
                ...
                <form @submit.prevent="Register()" class="signin-form">
                  ...
                  <div class="form-group">
                    <input type="text" v-model="username" class="form-control" placeholder="Tên đăng nhập" required>
                  </div>
                  <div class="form-group">
                    <input id="password-field" v-model="password" type="password" class="form-control" placeholder="Mật khẩu" required>
